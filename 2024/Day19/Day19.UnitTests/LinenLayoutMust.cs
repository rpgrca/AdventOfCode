...
public class LinenLayoutMust
{
    ...
    [InlineData(PUZZLE_INPUT, 390, 400)]
    ...
    [Theory]
    [InlineData("rbugwrbrgggbwbgrwwrrwrguuurbbuwwwgubrbwbrrrrgwggruurrbrg", 0)]
    [InlineData("uburuurwgwwbwrurwubgrurrgwrwbuuugrggrgwwbwuggwguubrbg", 1)]
    public void DetectLongChainCorrectly(string input, int expectedCount)
    {
    ...
    public void FindAllWaysOfArranging()
    {
        ...
        sut.FindAllValidCombinations();
        Assert.Equal(6UL, sut.AllValidCombinations);
    }
    ...
    public void SolveSecondSampleCorrectly()
    {
        var sut = new LinenLayout(SAMPLE_INPUT);
        sut.FindAllValidCombinations();
        Assert.Equal(16UL, sut.AllValidCombinations);
    }
    ...
    public void SolveSecondPuzzleCorrectly()
    {
        var sut = new LinenLayout(PUZZLE_INPUT);
        sut.FindAllValidCombinations();
        Assert.Equal(666491493769758UL, sut.AllValidCombinations);
    }
}