...
/*
    ...
    public List<List<string>> CalculateShortestSequence(List<List<string>> sequencesToType)
    {
        ...
        foreach (var sequenceToType in sequencesToType)
        {
            ...
            foreach (var option in sequenceToType)
            {
                ...
                BuildCombinations(optionsPerCharacter, subSequence, new());
            }
    ...
    private void BuildCombinations(List<List<string>> optionsPerCharacter, List<string> subSequence, List<string> accumulatedString, int index = 0)
    {
        if (index >= optionsPerCharacter.Count)
        {
            subSequence.Add(string.Concat(accumulatedString));
            return;
        }
        ...
        foreach (var option in optionsPerCharacter[index])
        {
            ...
            BuildCombinations(optionsPerCharacter, subSequence, accumulatedString, index + 1);
